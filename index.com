...
<head>
    ...
    <title>Pavithra - Digital Portfolio</title>
    <style>
        body { 
...
<body>
    ...
    <div class="container">
        ...
        <div id="education" class="section">
            <h2>Education</h2>
            <p><strong>HSC:</strong> Girls Higher Secondary School (89%)</p>
            <p><strong>SSLC:</strong> Girls Higher Secondary School (96%)</p>
        </div>
        <div id="skills" class="section">
            <h2>Technical Skills</h2>
            <p>Python, Linux, Java</p>
        </div>
...
Here’s the corrected and clean version of your portfolio code (without errors):
